...
func (repoStub) Save(_ context.Context, g *biz.Greeter) (*biz.Greeter, error) { return g, nil }
func (repoStub) Update(context.Context, *biz.Greeter) (*biz.Greeter, error)   { return nil, nil }
func (repoStub) FindByID(context.Context, int64) (*biz.Greeter, error)        { return nil, nil }
func (repoStub) ListByHello(context.Context, string) ([]*biz.Greeter, error)  { return nil, nil }
func (repoStub) ListAll(context.Context) ([]*biz.Greeter, error)              { return nil, nil }
...
func startGreeterServer(t *testing.T) (addr string, stop func()) {
	...
	uc := biz.NewGreeterUsecase(repoStub{}, remoteStub{}, logger)
	svc := service.NewGreeterService(uc)

	cfg := &conf.Server{Grpc: &conf.Server_GRPC{Addr: "127.0.0.1:0"}}
	grpcSrv := server.NewGRPCServer(cfg, svc, logger)
